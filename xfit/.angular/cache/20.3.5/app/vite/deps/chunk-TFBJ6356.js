  ...
  if (!n || !BUILD.hotModuleReplacement) {
    ...
    switch (a) {
      case "pwa-action-sheet":
        return import("./pwa-action-sheet.entry-46JGMNSK.js").then(s, consoleError);
      case "pwa-camera-modal":
        return import("./pwa-camera-modal.entry-ZUJ5T4LX.js").then(s, consoleError);
      case "pwa-toast":
        return import("./pwa-toast.entry-MFESVXYY.js").then(s, consoleError);
      case "pwa-camera-modal-instance":
        return import("./pwa-camera-modal-instance.entry-JYTTLW7I.js").then(s, consoleError);
      case "pwa-camera":
        return import("./pwa-camera.entry-72ESBHKN.js").then(s, consoleError);
    }
  }
...
//# sourceMappingURL=chunk-TFBJ6356.js.map
