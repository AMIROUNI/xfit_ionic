  ...
  if (!n || !BUILD.hotModuleReplacement) {
    ...
    switch (a) {
      case "pwa-action-sheet":
        return import("./pwa-action-sheet.entry-TMMZIWQM.js").then(s, consoleError);
      case "pwa-camera-modal":
        return import("./pwa-camera-modal.entry-GNYX4DSI.js").then(s, consoleError);
      case "pwa-toast":
        return import("./pwa-toast.entry-CNFIRGUL.js").then(s, consoleError);
      case "pwa-camera-modal-instance":
        return import("./pwa-camera-modal-instance.entry-3AHCAYEB.js").then(s, consoleError);
      case "pwa-camera":
        return import("./pwa-camera.entry-5QCIKKVB.js").then(s, consoleError);
    }
  }
...
//# sourceMappingURL=chunk-YCJERKR4.js.map
