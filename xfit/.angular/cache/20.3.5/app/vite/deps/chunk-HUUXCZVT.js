  ...
  if (!n || !BUILD.hotModuleReplacement) {
    ...
    switch (a) {
      case "pwa-action-sheet":
        return import("./pwa-action-sheet.entry-T25GIA3S.js").then(s, consoleError);
      case "pwa-camera-modal":
        return import("./pwa-camera-modal.entry-EQYYZSR2.js").then(s, consoleError);
      case "pwa-toast":
        return import("./pwa-toast.entry-WYIXQQLT.js").then(s, consoleError);
      case "pwa-camera-modal-instance":
        return import("./pwa-camera-modal-instance.entry-2M5JKZZM.js").then(s, consoleError);
      case "pwa-camera":
        return import("./pwa-camera.entry-WYVTZEF4.js").then(s, consoleError);
    }
  }
...
//# sourceMappingURL=chunk-HUUXCZVT.js.map
