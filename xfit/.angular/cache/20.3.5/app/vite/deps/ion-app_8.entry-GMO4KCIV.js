...
} from "./chunk-EVZ7KDKW.js";
import {
  isRTL
} from "./chunk-IYJE4RVC.js";
import {
  createLockController
} from "./chunk-VIQYN3V7.js";
...
import {
  attachComponent,
  detachComponent
} from "./chunk-CCELAMCS.js";
import {
  createColorClasses,
  hostContext
} from "./chunk-LZSLFHD5.js";
import {
  shouldUseCloseWatcher
} from "./chunk-7XKQCT4T.js";
import {
  transition
} from "./chunk-M7ZTFPLS.js";
import "./chunk-CEGSF6PK.js";
import {
  getIonMode,
  isPlatform
} from "./chunk-N3HPE2DK.js";
import {
  clamp,
  componentOnReady,
  hasLazyBuild,
  ...
  componentDidLoad() {
    {
      rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./index-ceb5RaMT-3X2G6ZLJ.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./status-tap-5DQ7Fc4V-34N5HQCL.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./input-shims-DyOpfTg6-F7ZAYKSO.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./hardware-back-button-CPLxO-Ev-XOZ4WAU3.js");
        ...
        if (typeof window !== "undefined") {
          import("./keyboard-ywgs5efA-HXGGCG5X.js").then((module) => module.startKeyboardAssist(window));
        }
        import("./focus-visible-BmVRXR1y-SFROAXUO.js").then((module) => this.focusVisible = module.startFocusVisible());
      }));
    }
  }
  /**
...
var RouterOutlet = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./swipe-back-BKw2CAHc-DHWWCK6F.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a;
...
@ionic/core/dist/esm/ion-app_8.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-app_8.entry-GMO4KCIV.js.map
